    ...
    <div className="min-h-screen bg-slate-50 font-sans tracking-tight relative overflow-hidden pb-32">
      ...
      {totalQuantity > 0 && (
        <div className="fixed bottom-0 left-0 right-0 p-4 z-40 bg-gradient-to-t from-slate-50 via-slate-50/90 to-transparent pointer-events-none pb-safe">
          <div className="pointer-events-auto shadow-[0_10px_40px_rgba(226,55,68,0.3)] bg-gradient-to-r from-[#E23744] to-[#f0535e] rounded-2xl p-4 flex justify-between items-center animate-[popIn_0.3s_ease-out_forwards] translate-y-10 opacity-0 relative overflow-hidden group border border-white/20 backdrop-blur-md">
